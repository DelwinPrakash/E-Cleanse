...
export default function Nav() {
    ...
    return (
        <nav>
            <div className="fixed bg-zinc-800 text-white flex sm:flex-col justify-around items-center w-full sm:w-16 h-14 sm:h-full bottom-0 sm:bottom-auto sm:left-0 z-50">
